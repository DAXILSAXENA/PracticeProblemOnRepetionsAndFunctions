...
# Fahrenheit to celcius and celcius to Fahrenheit using case
# and range btw 0/32 celcius/fahrenheit to 100/212 celcius/fahrenhiet
...
echo "Enter 1 for converting celcius to fahrenheit:"
echo "Enter 2 for converting fahrenheit to celcius:"
